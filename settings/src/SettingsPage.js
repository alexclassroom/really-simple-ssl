...
const SettingsPage = () => {
    ...
    const wizardNextPrevious = (isPrevious) => {
        const { nextMenuItem, previousMenuItem } = getPreviousAndNextMenuItems();
        setSelectedMenuItem(isPrevious ? previousMenuItem : nextMenuItem);
    }
...
// class SettingsPage2 extends Component {
//     constructor() {
//         super( ...arguments );
//         this.state = {
//             fields:'',
